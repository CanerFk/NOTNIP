...
type Tab = "appearance" | "typography" | "editor" | "data";
...
export function SettingsModal() {
  ...
  const ea = editorAppearance ?? EDITOR_DEFAULTS;
                  ...
                  <div className="relative">
                    ...
                    <div
                      className={cn(
                        ...
                        themePreferences.readableLineLength
                          ? "bg-accent"
                          : "bg-element",
                      )}
                    />
                ...
                <label className="flex items-center gap-3 cursor-pointer group w-fit">
                  <div className="relative">
                    ...
                    <div
                      className={cn(
                        "block w-10 h-5 border-2 border-border shadow-retro-sm transition-all",
                        (ea.justifyText ?? false) ? "bg-accent" : "bg-element",
                      )}
                    />
                    <div
                      className={cn(
                        "absolute left-1 top-1 w-2.5 h-2.5 transition-transform",
                        (ea.justifyText ?? false)
                          ? "translate-x-4 bg-background"
                          : "bg-main",
                      )}
                    />
            ...
            <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-300">
              <div>
                ...
                <p className="text-xs text-muted mb-4 opacity-80">
                  ...
                  automatically remapped to prevent overwriting.
                </p>
                <button
...
function SettingSlider({
  ...
  return (
    <div>
      ...
      />
      <div className="flex justify-between text-[9px] font-mono text-muted/40 mt-0.5">
